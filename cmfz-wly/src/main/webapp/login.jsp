    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#captchaImage").click(function () {//点击更换验证码
                $("#captchaImage").prop("src","${pageContext.request.contextPath}/createCode?date"+new Date());
            });
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/createCode" title="点击更换验证码"/>
                </td>
            </tr>
            <tr>
                <td>
